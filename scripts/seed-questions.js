...
const round1Questions = [
  // EASY - 15 Questions
  { type: 'mcq', difficulty: 'easy', question: 'What does SQL stand for?', options: ['Structured Query Language', 'Strong Query Language', 'Simple Query Language', 'Structured Question Language'], correctAnswer: 0, points: 10 },
  { type: 'mcq', difficulty: 'easy', question: 'Which SQL command is used to retrieve records from a table?', options: ['SELECT', 'RETRIEVE', 'GET', 'FETCH'], correctAnswer: 0, points: 10 },
  { type: 'mcq', difficulty: 'easy', question: 'Which SQL command is used to add new data to a table?', options: ['INSERT', 'ADD', 'APPEND', 'PUT'], correctAnswer: 0, points: 10 },
  { type: 'mcq', difficulty: 'easy', question: 'Which SQL command is used to modify existing records?', options: ['UPDATE', 'MODIFY', 'CHANGE', 'ALTER'], correctAnswer: 0, points: 10 },
  { type: 'mcq', difficulty: 'easy', question: 'Which SQL command is used to remove records from a table?', options: ['DELETE', 'REMOVE', 'DROP', 'ERASE'], correctAnswer: 0, points: 10 },
  { type: 'mcq', difficulty: 'easy', question: 'What is a PRIMARY KEY in a database?', options: ['A unique identifier for each record in a table', 'The first column in any table', 'A password to access the database', 'The most important data in a table'], correctAnswer: 0, points: 10 },
  { type: 'mcq', difficulty: 'easy', question: 'Which clause is used to filter records in SQL?', options: ['WHERE', 'FILTER', 'HAVING', 'IF'], correctAnswer: 0, points: 10 },
  { type: 'mcq', difficulty: 'easy', question: 'Which clause is used to sort results in SQL?', options: ['ORDER BY', 'SORT BY', 'ARRANGE BY', 'GROUP BY'], correctAnswer: 0, points: 10 },
  { type: 'mcq', difficulty: 'easy', question: 'What does DBMS stand for?', options: ['Database Management System', 'Data Backup Management System', 'Digital Base Management System', 'Database Maintenance System'], correctAnswer: 0, points: 10 },
  { type: 'mcq', difficulty: 'easy', question: 'Which SQL command creates a new table?', options: ['CREATE TABLE', 'NEW TABLE', 'MAKE TABLE', 'ADD TABLE'], correctAnswer: 0, points: 10 },
  { type: 'mcq', difficulty: 'easy', question: 'Which SQL command deletes an entire table?', options: ['DROP TABLE', 'DELETE TABLE', 'REMOVE TABLE', 'ERASE TABLE'], correctAnswer: 0, points: 10 },
  { type: 'mcq', difficulty: 'easy', question: 'What symbol is used to select all columns in SQL?', options: ['* (asterisk)', '# (hash)', '@ (at)', '& (ampersand)'], correctAnswer: 0, points: 10 },
  { type: 'mcq', difficulty: 'easy', question: 'Which keyword removes duplicate values from results?', options: ['DISTINCT', 'UNIQUE', 'DIFFERENT', 'SINGLE'], correctAnswer: 0, points: 10 },
  { type: 'mcq', difficulty: 'easy', question: 'What is a row in a database table also called?', options: ['Record or Tuple', 'Column or Field', 'Index or Key', 'Schema or Structure'], correctAnswer: 0, points: 10 },
  { type: 'mcq', difficulty: 'easy', question: 'What is a column in a database table also called?', options: ['Field or Attribute', 'Record or Tuple', 'Row or Entry', 'Index or Key'], correctAnswer: 0, points: 10 },

  // MEDIUM - 10 Questions
  { type: 'scenario', difficulty: 'medium', scenario: 'A library database stores books with columns: book_id, title, author, and year_published.', question: 'Which query retrieves all books written by "J.K. Rowling"?', options: ['SELECT * FROM books WHERE author = \'J.K. Rowling\'', 'GET books WHERE author = \'J.K. Rowling\'', 'FIND * FROM books IF author = \'J.K. Rowling\'', 'SELECT books WHERE author == \'J.K. Rowling\''], correctAnswer: 0, points: 15 },
  { type: 'mcq', difficulty: 'medium', question: 'Which SQL function counts the number of rows?', options: ['COUNT()', 'SUM()', 'TOTAL()', 'NUMBER()'], correctAnswer: 0, points: 15 },
  { type: 'mcq', difficulty: 'medium', question: 'Which SQL function calculates the average of a column?', options: ['AVG()', 'AVERAGE()', 'MEAN()', 'MID()'], correctAnswer: 0, points: 15 },
  { type: 'mcq', difficulty: 'medium', question: 'What is a FOREIGN KEY used for?', options: ['To link two tables together', 'To create a unique identifier', 'To encrypt sensitive data', 'To speed up queries'], correctAnswer: 0, points: 15 },
  { type: 'scenario', difficulty: 'medium', scenario: 'A Sales table has columns: sale_id, product_name, quantity, sale_date.', question: 'Which query shows total quantity sold for each product?', options: ['SELECT product_name, SUM(quantity) FROM Sales GROUP BY product_name', 'SELECT product_name, COUNT(quantity) FROM Sales ORDER BY product_name', 'SELECT product_name, SUM(quantity) FROM Sales ORDER BY product_name', 'SELECT product_name, TOTAL(quantity) FROM Sales GROUP BY product_name'], correctAnswer: 0, points: 15 },
  { type: 'mcq', difficulty: 'medium', question: 'Which clause is used with aggregate functions to filter groups?', options: ['HAVING', 'WHERE', 'FILTER', 'GROUP FILTER'], correctAnswer: 0, points: 15 },
  { type: 'mcq', difficulty: 'medium', question: 'What does NULL represent in a database?', options: ['Unknown or missing value', 'Zero', 'Empty string', 'False'], correctAnswer: 0, points: 15 },
  { type: 'mcq', difficulty: 'medium', question: 'Which JOIN returns only matching rows from both tables?', options: ['INNER JOIN', 'LEFT JOIN', 'RIGHT JOIN', 'FULL JOIN'], correctAnswer: 0, points: 15 },
  { type: 'mcq', difficulty: 'medium', question: 'Which command is used to add a new column to an existing table?', options: ['ALTER TABLE table_name ADD column_name', 'UPDATE TABLE table_name ADD column_name', 'INSERT COLUMN column_name INTO table_name', 'MODIFY TABLE table_name ADD column_name'], correctAnswer: 0, points: 15 },
  { type: 'mcq', difficulty: 'medium', question: 'What is normalization in databases?', options: ['Organizing data to reduce redundancy', 'Making all data uppercase', 'Encrypting sensitive information', 'Speeding up database queries'], correctAnswer: 0, points: 15 },

  // HARD - 5 Questions
  { type: 'scenario', difficulty: 'hard', scenario: 'A bank transfer moves Rs.5000 from Account A to Account B. The system debits A, then credits B.', question: 'Which ACID property ensures either both operations complete or neither does?', options: ['Atomicity', 'Consistency', 'Isolation', 'Durability'], correctAnswer: 0, points: 20 },
  { type: 'mcq', difficulty: 'hard', question: 'In 1NF (First Normal Form), what must be eliminated?', options: ['Repeating groups and multi-valued attributes', 'Partial dependencies', 'Transitive dependencies', 'Foreign key references'], correctAnswer: 0, points: 20 },
  { type: 'mcq', difficulty: 'hard', question: 'What is a Candidate Key?', options: ['A column or set of columns that can uniquely identify a row', 'A key waiting to be promoted to primary key', 'A temporary key used during data entry', 'A key that references another table'], correctAnswer: 0, points: 20 },
  { type: 'scenario', difficulty: 'hard', scenario: 'Two transactions T1 and T2 are running. T1 reads a value, T2 updates it, then T1 reads it again and gets a different value.', question: 'This scenario describes which concurrency problem?', options: ['Non-repeatable read', 'Dirty read', 'Phantom read', 'Lost update'], correctAnswer: 0, points: 20 },
  { type: 'mcq', difficulty: 'hard', question: 'Which ACID property ensures committed transactions survive system failures?', options: ['Durability', 'Atomicity', 'Consistency', 'Isolation'], correctAnswer: 0, points: 20 },
]
...
const round2Challenges = [
  {
    ...
    scenario: 'Techno Corp needs a list of all engineers for an important meeting.',
    schema: 'employees (emp_id, name, department, salary)',
    base_table_data: [{ tableName: 'employees', columns: [{ name: 'emp_id', type: 'INT', isPrimaryKey: true }, { name: 'name', type: 'VARCHAR' }, { name: 'department', type: 'VARCHAR' }, { name: 'salary', type: 'DECIMAL' }], rows: [[1, 'Alice', 'Engineering', 75000], [2, 'Bob', 'Sales', 55000], [3, 'Charlie', 'Engineering', 80000], [4, 'Diana', 'HR', 60000], [5, 'Eve', 'Engineering', 72000]] }],
    test_cases: [{ id: 1, name: 'Sample Test', description: 'Basic dataset with 5 employees', tableData: [{ tableName: 'employees', columns: [{ name: 'emp_id', type: 'INT', isPrimaryKey: true }, { name: 'name', type: 'VARCHAR' }, { name: 'department', type: 'VARCHAR' }, { name: 'salary', type: 'DECIMAL' }], rows: [[1, 'Alice', 'Engineering', 75000], [2, 'Bob', 'Sales', 55000], [3, 'Charlie', 'Engineering', 80000], [4, 'Diana', 'HR', 60000], [5, 'Eve', 'Engineering', 72000]] }], expectedOutput: [[1, 'Alice', 'Engineering', 75000], [3, 'Charlie', 'Engineering', 80000], [5, 'Eve', 'Engineering', 72000]], expectedColumns: ['emp_id', 'name', 'department', 'salary'], isHidden: false, points: 5 }],
  ...
  },
  {
    ...
    scenario: 'QuickMart needs a count of all orders for their monthly report.',
    schema: 'orders (order_id, customer_id, order_date, total_amount)',
    base_table_data: [{ tableName: 'orders', columns: [{ name: 'order_id', type: 'INT', isPrimaryKey: true }, { name: 'customer_id', type: 'INT' }, { name: 'order_date', type: 'DATE' }, { name: 'total_amount', type: 'DECIMAL' }], rows: [[101, 1, '2024-01-15', 2500], [102, 2, '2024-01-16', 1800], [103, 1, '2024-01-17', 3200], [104, 3, '2024-01-18', 950], [105, 2, '2024-01-19', 4100]] }],
    test_cases: [{ id: 1, name: 'Sample Test', description: '5 orders in dataset', tableData: [{ tableName: 'orders', columns: [{ name: 'order_id', type: 'INT', isPrimaryKey: true }, { name: 'customer_id', type: 'INT' }, { name: 'order_date', type: 'DATE' }, { name: 'total_amount', type: 'DECIMAL' }], rows: [[101, 1, '2024-01-15', 2500], [102, 2, '2024-01-16', 1800], [103, 1, '2024-01-17', 3200], [104, 3, '2024-01-18', 950], [105, 2, '2024-01-19', 4100]] }], expectedOutput: [[5]], expectedColumns: ['count'], isHidden: false, points: 5 }],
    expected_keywords: ['select', 'count', 'from', 'orders'],
    total_points: 15,
    time_limit: 180
  },
  {
    ...
    scenario: 'Marketing wants to identify premium customers for a loyalty program.',
    schema: 'customers (customer_id, name, email, total_spent)',
    base_table_data: [{ tableName: 'customers', columns: [{ name: 'customer_id', type: 'INT', isPrimaryKey: true }, { name: 'name', type: 'VARCHAR' }, { name: 'email', type: 'VARCHAR' }, { name: 'total_spent', type: 'DECIMAL' }], rows: [[1, 'Rahul', 'rahul@email.com', 15000], [2, 'Priya', 'priya@email.com', 8500], [3, 'Amit', 'amit@email.com', 22000], [4, 'Sneha', 'sneha@email.com', 5000], [5, 'Vikram', 'vikram@email.com', 12500]] }],
    test_cases: [{ id: 1, name: 'Sample Test', description: 'Standard customer dataset', tableData: [{ tableName: 'customers', columns: [{ name: 'customer_id', type: 'INT', isPrimaryKey: true }, { name: 'name', type: 'VARCHAR' }, { name: 'email', type: 'VARCHAR' }, { name: 'total_spent', type: 'DECIMAL' }], rows: [[1, 'Rahul', 'rahul@email.com', 15000], [2, 'Priya', 'priya@email.com', 8500], [3, 'Amit', 'amit@email.com', 22000], [4, 'Sneha', 'sneha@email.com', 5000], [5, 'Vikram', 'vikram@email.com', 12500]] }], expectedOutput: [[1, 'Rahul', 'rahul@email.com', 15000], [3, 'Amit', 'amit@email.com', 22000], [5, 'Vikram', 'vikram@email.com', 12500]], expectedColumns: ['customer_id', 'name', 'email', 'total_spent'], isHidden: false, points: 5 }],
  ...
  },
  {
    ...
    scenario: 'A budget-conscious shopper wants to see products starting from cheapest.',
    schema: 'products (product_id, name, category, price)',
    base_table_data: [{ tableName: 'products', columns: [{ name: 'product_id', type: 'INT', isPrimaryKey: true }, { name: 'name', type: 'VARCHAR' }, { name: 'category', type: 'VARCHAR' }, { name: 'price', type: 'DECIMAL' }], rows: [[1, 'Laptop', 'Electronics', 45000], [2, 'Mouse', 'Electronics', 500], [3, 'Keyboard', 'Electronics', 1200], [4, 'Monitor', 'Electronics', 15000], [5, 'USB Cable', 'Electronics', 150]] }],
    test_cases: [{ id: 1, name: 'Sample Test', description: 'Sort 5 products by price', tableData: [{ tableName: 'products', columns: [{ name: 'product_id', type: 'INT', isPrimaryKey: true }, { name: 'name', type: 'VARCHAR' }, { name: 'category', type: 'VARCHAR' }, { name: 'price', type: 'DECIMAL' }], rows: [[1, 'Laptop', 'Electronics', 45000], [2, 'Mouse', 'Electronics', 500], [3, 'Keyboard', 'Electronics', 1200], [4, 'Monitor', 'Electronics', 15000], [5, 'USB Cable', 'Electronics', 150]] }], expectedOutput: [[5, 'USB Cable', 'Electronics', 150], [2, 'Mouse', 'Electronics', 500], [3, 'Keyboard', 'Electronics', 1200], [4, 'Monitor', 'Electronics', 15000], [1, 'Laptop', 'Electronics', 45000]], expectedColumns: ['product_id', 'name', 'category', 'price'], isHidden: false, points: 8 }],
  ...
  },
  {
    ...
    scenario: 'The new HR intern needs to know all different departments.',
    schema: 'employees (emp_id, name, department, salary)',
    base_table_data: [{ tableName: 'employees', columns: [{ name: 'emp_id', type: 'INT', isPrimaryKey: true }, { name: 'name', type: 'VARCHAR' }, { name: 'department', type: 'VARCHAR' }, { name: 'salary', type: 'DECIMAL' }], rows: [[1, 'John', 'IT', 80000], [2, 'Jane', 'HR', 70000], [3, 'Jack', 'IT', 85000], [4, 'Jill', 'Finance', 75000]] }],
    test_cases: [{ id: 1, name: 'Sample Test', description: 'Find unique departments', tableData: [{ tableName: 'employees', columns: [{ name: 'emp_id', type: 'INT', isPrimaryKey: true }, { name: 'name', type: 'VARCHAR' }, { name: 'department', type: 'VARCHAR' }, { name: 'salary', type: 'DECIMAL' }], rows: [[1, 'John', 'IT', 80000], [2, 'Jane', 'HR', 70000], [3, 'Jack', 'IT', 85000], [4, 'Jill', 'Finance', 75000]] }], expectedOutput: [['IT'], ['HR'], ['Finance']], expectedColumns: ['department'], isHidden: false, points: 5 }],
    expected_keywords: ['select', 'distinct', 'department', 'from', 'employees'],
    total_points: 15,
    time_limit: 180
  },
]
    ...
    const { error: r2Error } = await supabase
      ...
      .insert(
        round2Challenges.map((c, idx) => ({
          ...c,
          base_table_data: c.base_table_data,
